"""
Year-End Party Chatbot with Zodiac Theme - Enhanced UI Version
"""
...
zodiac_symbols = ['♈', '♉', '♊', '♋', '♌', '♍', '♎', '♏', '♐', '♑', '♒', '♓']
zodiac_svg_path = r"D:\KenIChi\Chatbot\data\images\zodiac_signs"
            ...
            if result:
                ...
                if user_data:
                    ...
                    '>
                        ...
                        {f"<p style='color: #64748b; margin-bottom: 24px; font-size: 1.1rem;'><strong>🏢 Nhóm:</strong> {user_data['team']}</p>" if user_data.get('team') else ''}
                        
                        <h3 style='font-size: 1.5rem; color: #f59e0b; margin-bottom: 16px;'>
                            🔮 Lời bói của bạn:
                        </h3>
                        <div style='
